  ...
  render() {
    ...
    return (
      <div className="container">
        {/*<img src={logo} alt="React Logo" className = 'logo' ></img>*/}
        {/* <h1>Positioning</h1> */}
        <p>I am a basic block level element very very very very very very very very very very very very very very .</p>
        <p className="positioned">positioned.</p>
        <p>I am a very long basic block level element very very very very very very very very very very very very very very .</p>      
      </div>
    )}
}
